...
class BookmarkControllerTest {
    ...
    void shouldCreateBookmark() {
        var newBookmark =
                new BookmarkController.CreateBookmarkPayload("JetBrains Academy", "https://www.jetbrains.com/academy/");
    ...
    @Test
    void shouldNotBeAbleToCreateBookmarkWithInvalidData() {
        var newBookmark =
                new BookmarkController.CreateBookmarkPayload(" ", "https://www.jetbrains.com/academy/");
